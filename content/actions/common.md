...
#### Powell Intranet Sites Pages Create a new page
1. [Go to Sites](#powell-intranet-sites)
2. *Pages* on the left column
3. *Create a new page*
4. In the creation dialog, we recommend using the *Not Linked* option for *Copy Type* so you can edit the page later. For more info please click on the question mark next to the *Copy Type* label.
